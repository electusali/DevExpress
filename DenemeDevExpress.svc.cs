...
{
	public class DenemeDevExpressContext : XpoContext
	{
		public DenemeDevExpressContext(string s1, string s2, IDataLayer dataLayer)
	...
	[JSONPSupportBehavior]
#endif
	public class DenemeDevExpressService : XpoDataServiceV3
	{
		static readonly DenemeDevExpressContext serviceContext = new DenemeDevExpressContext("DenemeDevExpressService", "DenemeDevExpress", CreateDataLayer());

		public DenemeDevExpressService() : base(serviceContext, serviceContext) { }
